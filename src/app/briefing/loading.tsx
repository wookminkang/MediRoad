...
export default function Loading() {
  ...
  return (
    <PageContainer maxWidth="max-w-7xl">
      {/* 헤더 */}
      <div className="h-9 w-44 animate-pulse" style={block} />
      <div className="mt-3 h-5 w-80 max-w-full animate-pulse" style={block} />
