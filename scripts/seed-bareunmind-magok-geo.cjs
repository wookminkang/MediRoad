 ...
 *
 * 피부미용센터 — 병원 확인을 받아 반영했다 (2026-07-14).
 * 공식 홈페이지에는 이 센터가 없어서(피부·미용 진료 항목 자체가 없다) 처음에는 빼두고
 * 병원에 확인을 요청했다. 병원이 "운영한다"고 확인해줘서 넣는다.
 * 홈페이지에 없는 진료를 홈페이지만 보고 지어내면 의료광고법 위반이 되므로, 근거는
 * 홈페이지 아니면 병원 확인 둘 중 하나여야 한다.
 *
...
const DESCRIPTION = [
  ...
  "피부미용센터와 통증 입원센터를 나누어 운영합니다. 피부미용센터는 피부 트러블 등 피부 고민에 대한 한방 진료·관리를 상담하고, 통증 입원센터는 허리·목 디스크와 협착증, 어깨·무릎 통증, 교통사고 후유증, 수술 후 재활 등 근골격계 통증을 진료합니다.",
  "추나치료·침·약침·한약 치료와 함께 7층 입원실에서 입원 치료를 운영하며, 한방 다이어트 프로그램도 진행합니다. 진료 적용 여부는 환자 상태에 따라 의료진이 판단하며, 정확한 진료 가능 여부는 방문 전 상담으로 확인하시기 바랍니다.",
].join(" ");
...
const FAQS = [
  {
    ...
    a: "바른마음한의원 마곡발산점은 서울 강서구 마곡동에 위치한 한의원으로, 피부미용센터와 통증 입원센터를 나누어 운영합니다. 피부 고민은 피부미용센터에서, 허리·목 디스크와 협착증, 어깨·무릎 통증, 교통사고 후유증은 통증 입원센터에서 진료합니다.",
  },
  {
    // 병원 확인으로 반영 (홈페이지에는 없던 내용)
    q: "마곡·발산에서 피부 고민을 한방으로 상담할 수 있나요?",
    a: "바른마음한의원 마곡발산점은 피부미용센터를 운영하며, 피부 트러블 등 피부 고민에 대한 한방 진료·관리를 상담합니다. 피부 상태와 체질, 생활습관을 함께 살펴 접근하며, 적용 가능한 진료와 관리 방법은 개인의 피부 상태에 따라 달라지므로 상담을 통해 확인할 수 있습니다.",
  },
  {
