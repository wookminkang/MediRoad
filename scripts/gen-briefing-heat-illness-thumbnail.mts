/**
 * 메디브리핑(폭염·온열질환) 썸네일 — OpenAI 이미지 + 타이틀/로고 합성 → Storage 업로드.
 * 실행: node --env-file=.env.local --import tsx scripts/gen-briefing-heat-illness-thumbnail.mts
 */
...
// === 이 브리핑용 설정 ===
const COLUMN_ID = "briefing-heat-illness";
const THUMB_TITLE = "폭염 온열질환 대처";
const PROMPT =
  "A clean, bright editorial photo about summer heat and hydration for a public-health article in Korea. A calm outdoor scene under strong summer sunlight: a hand holding a clear water bottle, a wide-brim straw hat and a small cooling towel resting nearby, bright blue sky with a subtle heat-haze feeling. Soft natural daylight, shallow depth of field, modern minimal aesthetic, gentle medical-blue accents, caring and trustworthy mood. Photorealistic, no text, no logos, subject placed in the upper-center, lower third kept simple and uncluttered.";
